...
export const CtaSection = () => {
  return (
    <section className="relative z-0 mx-auto my-12 flex w-full max-w-3xl flex-col items-center justify-center overflow-hidden rounded-4xl border-2 border-emerald-300/20 px-6 py-12 shadow-lg bg-black/60">
