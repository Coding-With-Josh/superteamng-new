        ...
        <div className="custom-horizontal-scrollbar overflow-x-auto pb-4">
          <div className="flex gap-4 sm:gap-6">
            {products.map((product) => (
              <div
                key={product.id}
                className="group flex min-w-[320px] flex-col rounded-xl border border-black/10 bg-white/80 transition-all hover:border-black/20 hover:shadow-lg dark:border-white/10 dark:bg-black/60 dark:hover:border-white/20 sm:min-w-[360px]"
              >
                {/* Logo/Image Area */}
                <div className="relative h-48 w-full overflow-hidden rounded-t-xl bg-black dark:bg-zinc-900">
                ...
                <div className="flex flex-1 flex-col p-6">
                  <div className="mb-3 flex items-start justify-between gap-3">
                    <h3 className="font-medium text-xl font-serif text-black tracking-tight dark:text-white sm:text-2xl">
                      {product.name}
                    </h3>
                    {product.badge && (
                  ...
                  <p className="mb-4 flex-1 text-sm text-black/70 leading-relaxed tracking-tight dark:text-white/70 sm:text-base">
                    {product.description}
                  </p>
